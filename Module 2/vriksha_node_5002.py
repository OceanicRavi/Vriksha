...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Ravi', amount = 1)
    block = blockchain.create_block(proof, previous_hash)
    response = {'message': 'Congartulation', 
                'index': block['index'],
...
def connect_node():
    ...
    response = {'message': 'All the nodes are connected. Vriksha now contains:',
...
def replace_chain():
  ...
  if is_chain_replaced: 
        ...
        response = {'message': 'already updated chain',
